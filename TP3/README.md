...
<head>
    <title>TP N°3: Supervised Classification - Learning and Evaluation</title>
</head>
...
<body>
    ...
    <ol>
        <li><strong>Iris:</strong>
            <ul>
                <li>Description: Dataset introduced by Ronald Aylmer Fisher in 1936...</li>
                <li>Attributes: Four attributes per instance...</li>
                <li>To load and display Iris dataset: Instructions provided...</li>
            </ul>
        </li>
